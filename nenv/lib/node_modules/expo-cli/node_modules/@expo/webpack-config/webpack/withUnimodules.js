...
function _findBabelLoader(rules) {
    ...
    if (!loader)
        throw new Error('Cannot find `babel-loader` generated by `webpack.config.unimodules`. It is likely an Expo issue. Please create a new issue at https://github.com/expo/expo-cli.');
    return loader;
}
...
function withUnimodules(inputWebpackConfig = {}, env = {}, argv = {}) {
    ...
    const config = webpack_config_unimodules_1.default(environment, Object.assign({}, argv, { supportsFontLoading }));
